"""Tests for the longer trained Empty-5x5 rollout-ready PPO root case."""
...
@pytest.mark.slow
class TestNavixPpoRolloutLongTrainedCheckpointCase:
    ...
    def test_materializes_completed_root_with_restorable_checkpoint(self, tmp_path: Path) -> None:
        context = materialize_case_in_training_subprocess(CASE, tmp_path / "rollout_long_trained")
